...
export const RequestAirdrop: FC = () => {
    ...
    const onClick = useCallback(async () => {
        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (signature) {
                    ...
                    notify({ type: 'success', message: 'Airdrop successful! (via faucet.solana.com)', txid: signature });
            ...
            // If faucet API returned an error, extract the message
        ...
        try {
            ...
            const is429 = error?.message?.includes('429') || error?.code === 429;
            if (is429) {
                notify({
                    type: 'error',
